...
Refresh the HealthDirect cache before rebuilding the static payload when health data needs an update:

```bash
python scripts/download_healthdirect_facilities.py
...
- National HealthDirect general practice, hospital and pharmacy locations.
